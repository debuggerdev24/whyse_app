...
class SearchBooksField extends StatefulWidget {
  final TextEditingController controller;
  final ValueChanged<String> onChanged;

  const SearchBooksField({
    super.key,
  ...
  @override
  State<SearchBooksField> createState() => _SearchBooksFieldState();
}

class _SearchBooksFieldState extends State<SearchBooksField> {
  late final FocusNode _focusNode;
  final String hintText = "What book are you looking for?";
  ...
  @override
  void didUpdateWidget(covariant SearchBooksField oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        contentPadding: EdgeInsets.symmetric(horizontal: 20, vertical: 10.h),
...
class GlassChip extends StatelessWidget {
  ...
  const GlassChip({super.key, required this.label, required this.textColor});
...
class InterestChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: AppText(
        text: label,
        style: AppTextStyles.semibold(fontSize: 12.sp, color: AppColors.teal),
      ),
    );
  }
}
...
class BrowseEmptyState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          Icon(Icons.search_off_rounded, size: 44.sp, color: AppColors.teal),
          14.w.verticalSpace,
          AppText(
