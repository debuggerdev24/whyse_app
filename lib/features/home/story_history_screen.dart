...
import '../../../models/home/story_models/story_model.dart' hide StoryQuiz;
...
class StoryHistoryScreen extends StatefulWidget {
  ...
  const StoryHistoryScreen({super.key, this.story});
...
class _StoryHistoryScreenState extends State<StoryHistoryScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (!mounted) return;
      final fromStory = widget.story?.metadata.lessonDuration;
