    ...
    return Scaffold(
      ...
      body: Consumer<AuthProvider>(
        ...
        Stack(
                ...
                AppFilledButton(
                  onTap: () async {
                    if (context.mounted) {
                      ...
                      final resgisteredUserMail =
                          LocalStorageService.instance.getRegisteredUserMail;
                      if (googleIdToken.isNotEmpty) {
                        await provider.loginWithGoogle(
                          idToken: LocalStorageService.instance.getGoogleIdToken,
                          onFailed: (error) {
                          ...
                          onAccountFound: () {
                            ...
                            LocalStorageService.instance.removeGoogleIdToken();
                          },
                        );
                        return;
                      }
                      if (resgisteredUserMail.isNotEmpty) {
                        provider.loginEmailCtr.text =
                            LocalStorageService.instance.getRegisteredUserMail;
                        provider.loginPasswordCtr.text =
                            LocalStorageService.instance.getRegisteredUserPassword;
          ...
          if (provider.isSocialLoginLoading || provider.isLoginLoading) FullPageIndicator(),
          ],
        ),
      ),
    );
